...
const MultipleCounter = () => {
    ...
    return (
        <div>
            <CounterGroupGenerator size={size} setSize={setSize} handleReset={handleReset}/>
            <Sum sum={sum}/>
            <CounterGroup sizeWhenReset={sizeWhenReset} countList={countList} setCountList={setCountList} sum={sum} setSum={setSum}/>
        </div>
    );
}
